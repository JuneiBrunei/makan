...
const FOOD_CATEGORIES: MenuCategory[] = [
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Конское ассорти (жая, казы, язык)', '6599 ₸'],
      ['Рулетики из баклажанов с орехами', '3099 ₸'],
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Чечевичный суп', '1350 ₸'],
      ['Сборная солянка', '1699 ₸'],
      ['Лапша по-домашнему (курица, лапша, специи)', '1299 ₸'],
      ['Бозбаш (баранина, нут, картошка, лук, помидор, специи)', '2799 ₸'],
      ['Домашние пельмени (фарш говядины, лук, тесто, сметана, специи)', '1699 ₸'],
      ['Мясо по-казахски (мясо, казы, тесто, бульон, лук)', '2199 ₸'],
      ['Хаш — традиционный кавказский суп (говяжьи ножки, чеснок, зелень, бульон, лаваш)', '2499 ₸'],
      ['Том-ям (креветки, шампиньоны, черри, лук, кокосовое молоко, паста том-ям, лайм, кинза, чили по вкусу)', '3799 ₸']
    ),
  },
  {
    title: 'Салаты',
    groups: items(
      ...
      ['Цезарь с сёмгой (айсберг, сёмга, черри, пармезан, сухарики, яйцо, соус «цезарь»)', '3099 ₸'],
      ['Цезарь с курицей (айсберг, куриное филе в кляре, черри, пармезан, сухарики, соус «цезарь», яйцо)', '2699 ₸'],
      ['Греческий салат (помидоры, огурцы, перец, оливки, лимон, лист салата, красный лук, масло, брынза)', '2299 ₸'],
      ['Острый салат «Арзу» (огурцы, сладкий перец, красный лук, чеснок, говядина, острый перец, соевый соус, масло)', '2299 ₸'],
      ['Салат от шефа (жареная брынза, черри, шампиньоны, чеснок, масло)', '2699 ₸'],
      ['Салат с куркумой (цветная капуста, брокколи, перец, черри, куриное филе, соус с куркумой)', '2599 ₸'],
      ...
      ['Малибу (копченая куриная грудка, помидор, огурцы, сыр)', '2199 ₸'],
      ['Свежий салат (помидоры, огурцы, лук)', '1599 ₸']
    ),
  },
  {
  ...
  },
  {
    title: 'Вторые блюда',
    groups: items(
      ['Жаровня из говядины', '2999 ₸'],
      ['Мясо по-тайски на жаровне (говядина, перец болгарский, лук, чеснок, чили по желанию, соевый соус)', '2599 ₸'],
      ['Хинкали с мясом', '2799 ₸'],
      ['Баранина по-грузински (баранина, болгарский перец, томатная паста, грузинские специи, лук)', '2799 ₸'],
      ['Бефстроганов (говядина, лук, сливки; гарнир отдельно)', '2399 ₸'],
      ...
      ['Оджахури (курица, лук, картофель, помидоры, зелень, специи)', '2599 ₸'],
      ['Куриная грудка с грибами в сливочном соусе', '2999 ₸'],
      ['Котлеты по-домашнему, 2 шт (гарнир отдельно)', '1599 ₸'],
      ['Казан кебаб', '3099 ₸'],
      ['Фри с мясом', '2699 ₸'],
      ['Цыплята табака', '2599 ₸'],
      ['Телятина со сметаной и грибами', '2999 ₸'],
      ['Долма', '2799 ₸']
    ),
  },
  {
  ...
  },
  {
    title: 'Пицца',
    groups: items(
      ['Пицца пепперони', '2799 ₸'],
      ['Пицца маргарита', '2599 ₸'],
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Люля из баранины', '1700 ₸'],
      ['Кавказский', '2700 ₸'],
      ['Окорочка', '1350 ₸'],
      ['Крылышки', '1400 ₸'],
      ['Шашлык из утки', '1400 ₸'],
      ['Печень в оболочке', '1700 ₸'],
      ['Грибы', '1600 ₸'],
      ['Овощи', '1200 ₸']
    ),
  },
  {
    title: 'Блюда на компанию (6 персон)',
    groups: items(
      ['Традиционный бесбармак', '18999 ₸'],
      ['Куырдак из баранины', '19499 ₸'],
      ['Сырне', '19499 ₸'],
      ['День и ночь (говядина, куриное филе, грибы, перец, лук)', '18999 ₸'],
      ['Хашлама (говядина, картофель, лук, полугорький перец)', '18999 ₸'],
      ['Сач (баранина, перец, овощи гриль)', '18999 ₸'],
      ['Манты', '13799 ₸']
    ),
  },
  {
    ...
    groups: items(
      ['Чесночный соус', '399 ₸'],
      ['Белый соус с зеленью', '499 ₸'],
      ['Шашлычный соус (красный)', '499 ₸'],
      ['Сырный соус', '399 ₸'],
      ['Кетчуп', '299 ₸'],
      ['Майонез', '299 ₸']
    ),
  },
  {
    title: 'Блюда из рыбы',
    groups: items(
      ['Форель со сливочным соусом', '4599 ₸'],
      ['Филе судака (гарнир отдельно)', '2399 ₸']
    ),
  },
  {
    title: 'Стейки',
    groups: items(
      ...
      ['Тибон с овощами', '6099 ₸'],
      ['Стейк из форели', '5299 ₸'],
      ['Стейк из лосося', '5299 ₸']
    ),
  },
  {
    title: 'Паста',
    groups: items(
      ['Феттучини альфредо с сёмгой', '4199 ₸'],
      ['Феттучини альфредо с курицей', '2999 ₸'],
      ['Феттучини альфредо с креветками', '3999 ₸'],
      ['Болоньезе', '2899 ₸']
    ),
  },
  {
