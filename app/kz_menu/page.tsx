...
const FOOD_CATEGORIES: MenuCategory[] = [
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Жаңғақ қосылған баклажан орамалары', '3099 ₸'],
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Бозбаш (қой еті, нут, картоп, пияз, қызанақ, дәмдеуіштер)', '2799 ₸'],
      ['Үй тұшпарасы (сиыр тартылған еті, пияз, қамыр, қаймақ, дәмдеуіштер)', '1699 ₸'],
      ['Қазақша ет (ет, қазы, қамыр, сорпа, тұздық)', '2199 ₸'],
      ['Хаш — дәстүрлі кавказ сорпасы (сиыр сирақтары, сарымсақ, көкөніс, сорпа, лаваш)', '2499 ₸'],
      ['Том-ям (шаяндар, шампиньон, черри, пияз, кокос сүті, том-ям пастасы, лайм, кинза, ащы бұрыш қалауыңызша)', '3799 ₸']
    ),
  },
  {
    title: 'Салаттар',
    groups: items(
      ...
      ['Сёмга қосылған Цезарь (айсберг, сёмга, черри, пармезан, сухари, жұмыртқа, «цезарь» соусы)', '3099 ₸'],
      ['Тауық қосылған Цезарь (айсберг, клярдағы тауық филесі, черри, пармезан, сухари, «цезарь» соусы, жұмыртқа)', '2699 ₸'],
      ['Грек салаты (қызанақ, қияр, бұрыш, зәйтүн, лимон, салат жапырағы, қызыл пияз, май, брынза)', '2299 ₸'],
      ['«Арзу» ащы салаты (қияр, тәтті бұрыш, қызыл пияз, сарымсақ, сиыр еті, ащы бұрыш, соя соусы, май)', '2299 ₸'],
      ['Шефтен салат (қуырылған брынза, черри, шампиньондар, сарымсақ, май)', '2699 ₸'],
      ['Куркума қосылған салат (гүлді орамжапырақ, брокколи, бұрыш, черри, тауық филесі, куркума соусы)', '2599 ₸'],
      ...
      ['Малибу (қақталған тауық төсі, қызанақ, қияр, ірімшік)', '2199 ₸'],
      ['Балғын салат (қызанақ, қияр, пияз)', '1599 ₸']
    ),
  },
  {
    title: 'Ыстық баптар',
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Ірімшік қосылған хычиндар', '1599 ₸']
    ),
  },
  {
    title: 'Негізгі тағамдар',
    groups: items(
      ['Сиыр етінен жасалған таба (жаровня)', '2999 ₸'],
      ['Табада тайша дайындалған ет (сиыр еті, тәтті бұрыш, пияз, сарымсақ, ащы бұрыш қалауыңызша, соя соусы)', '2599 ₸'],
      ['Ет қосылған хинкали', '2799 ₸'],
      ['Грузинше қой еті (қой еті, тәтті бұрыш, томат пастасы, грузин дәмдеуіштері, пияз)', '2799 ₸'],
      ['Бефстроганов (сиыр еті, пияз, қаймақ; гарнир бөлек)', '2399 ₸'],
      ...
      ['Оджахури (тауық еті, пияз, картоп, қызанақ, көкөніс, дәмдеуіштер)', '2599 ₸'],
      ['Сұйық қаймақ соусындағы саңырауқұлақ қосылған тауық төсі', '2999 ₸'],
      ['Үй котлеттері, 2 дана (гарнир бөлек)', '1599 ₸'],
      ['Қазан кебаб', '3099 ₸'],
      ['Фри мен ет', '2699 ₸'],
      ['Табада қуырылған балапан', '2599 ₸'],
      ['Қаймақ пен саңырауқұлақ қосылған бұзау еті', '2999 ₸'],
      ['Долма', '2799 ₸']
    ),
  },
  {
  ...
  },
  {
    title: 'Пицца',
    groups: items(
      ['Пепперони пиццасы', '2799 ₸'],
      ['Маргарита пиццасы', '2599 ₸'],
      ['Тауық пиццасы', '3299 ₸'],
      ['«4 жыл мезгілі» пиццасы', '2999 ₸'],
      ['«Цезарь» пиццасы', '3399 ₸']
    ),
  },
  {
  ...
  },
  {
    ...
    groups: items(
      ['Қой еті', '1800 ₸'],
      ['Қой етінен жасалған антрекот', '2800 ₸'],
      ['Қой етінен жасалған люля', '1700 ₸'],
      ['Кавказша кәуап', '2700 ₸'],
      ['Тауық сирақтары (окорочка)', '1350 ₸'],
      ['Тауық қанатшалары', '1400 ₸'],
      ['Үйрек етінен кәуап', '1400 ₸'],
      ['Қабықшадағы бауыр', '1700 ₸'],
      ['Саңырауқұлақтар', '1600 ₸'],
      ['Көкөністер', '1200 ₸']
    ),
  },
  {
    title: 'Топқа арналған ас (6 адамға)',
    groups: items(
      ['Дәстүрлі бесбармақ', '18999 ₸'],
      ['Қой етінен жасалған қуырдақ', '19499 ₸'],
      ['Сірне', '19499 ₸'],
      ['Күн мен түн (сиыр еті, тауық филесі, саңырауқұлақтар, бұрыш, пияз)', '18999 ₸'],
      ['Хашлама (сиыр еті, картоп, пияз, жартылай ащы бұрыш)', '18999 ₸'],
      ['Сач (қой еті, бұрыш, грильде пісірілген көкөністер)', '18999 ₸'],
      ['Манты', '13799 ₸']
    ),
  },
  {
    ...
    groups: items(
      ['Сарымсақ соусы', '399 ₸'],
      ['Шөп қосылған ақ соус', '499 ₸'],
      ['Кәуап соусы (қызыл)', '499 ₸'],
      ['Ірімшік соусы', '399 ₸'],
      ['Кетчуп', '299 ₸'],
      ['Майонез', '299 ₸']
    ),
  },
  {
    ...
    groups: items(
      ['Қаймақ соусындағы ақбалық (Форель)', '4599 ₸'],
      ['Көксерке филесі (гарнирі бөлек)', '2399 ₸'],
    ),
  },
  {
    title: 'Стейктер',
    groups: items(
      ...
      ['Көкөністер қосылған Тибон', '6099 ₸'],
      ['Ақбалықтан жасалған стейк (Форель)', '5299 ₸'],
      ['Лососьтен жасалған стейк', '5299 ₸']
    ),
  },
  {
    title: 'Паста',
    groups: items(
      ['Сёмга қосылған Феттучини альфредо', '4199 ₸'],
      ['Тауық қосылған Феттучини альфредо', '2999 ₸'],
      ['Шаяндар қосылған Феттучини альфредо', '3999 ₸'],
      ['Болоньезе', '2899 ₸']
    ),
  },
  {
