...
const FOOD_CATEGORIES: MenuCategory[] = [
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Шефтен салат (қуырған брынза, черри, шампиньондар, сарымсақ, май)', '2499 ₸'],
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Ірімшік пен картоп қосылған хычындар', '1599 ₸']
    ),
  },
  {
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Сырне', '6 адамға — 19499 ₸ · 4 адамға — 14499 ₸'],
      ['Күріш қосылған Дапанжи', '6 адамға — 13999 ₸ · 4 адамға — 10999 ₸'],
      ['Сиыр еті қосылған мерекелік палау', '6 адамға — 16999 ₸ · 4 адамға — 12999 ₸'],
      ['Мәнті', '6 адамға — 10499 ₸'],
      ['Көктал', '27999 ₸']
    ),
  },
  {
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Қуырған көксерке (картоп пюресімен)', '3599 ₸'],
  ...
  },
  {
    ...
    groups: items(
      ['Ет сеті (қой қабырғалары, антрекоттар, сиыр медальондары, тауық сирақтары, грильдегі жылқы шұжығы, долма, грильдегі көкөністер, пісірілген картоп, соустар)', '27999 ₸'],
      ['Балық платосы (форель, лосось, көксерке филесі, лимондар, грильдегі көкөністер, күріш)', '33999 ₸'],
      ['Құс етінен жасалған сет (тауық сирақтары, қанаттары, филе, үйрек еті, көкөністер, фри картобы)', '22999 ₸']
    ),
  },
  {
    title: 'Десерттер',
