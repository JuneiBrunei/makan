...
const FOOD_CATEGORIES: MenuCategory[] = [
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Том-ям (сегізаяқ/шаян, шампиньон, черри, пияз, кокос сүті, том-ям пастасы, лайм, кинза, ащы бұрыш қалауыңызша)', '3799 ₸']
    ),
  },
  {
    title: 'Салаттар',
  ...
  },
  {
    ...
    groups: items(
      ['Сиыр етінен жасалған таба (жаровня)', '2799 ₸'],
      ...
      ['Қаймақ пен саңырауқұлақ қосылған бұзау еті', '2399 ₸'],
      ['Долма', '2799 ₸']
    ),
  },
  {
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Хашлама (сиыр еті, картоп, пияз, жартылай ащы бұрыш)', '17999 ₸'],
