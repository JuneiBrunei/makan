...
const FOOD_CATEGORIES: MenuCategory[] = [
  ...
  },
  {
    ...
    groups: items(
      ...
      ['Бозбаш (қой еті, нут, картоп, пияз, қызанақ, дәмдеуіштер)', '2499 ₸'],
  ...
  },
  {
    ...
    groups: items(
      ['Дәстүрлі бесбармақ', '6 адамға — 18999 ₸ · 4 адамға — 13999 ₸'],
      ['Қой етінен жасалған қуырдақ', '6 адамға — 19499 ₸ · 4 адамға — 13499 ₸'],
      ['Сірне', '6 адамға — 19499 ₸ · 4 адамға — 14499 ₸'],
      ['Күн мен түн (сиыр еті, тауық филесі, саңырауқұлақтар, бұрыш, пияз)', '6 адамға — 18999 ₸'],
      ['Манты', '6 адамға — 13800 ₸']
    ),
  },
  {
