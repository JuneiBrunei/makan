...
const explore = [
  { label: 'Мәзір', href: '/kz_menu', text: 'Күн сайын ұсынатын грузин тағамдары, шашлық және десерттер.' },
  { label: 'Галерея', href: '/kz_gallery', text: 'Зал, интерьер бөлшектері және Кавказ тауларының атмосферасы.' },
  { label: 'Байланыстар', href: '/kz_main#contacts', text: 'Мекенжай, жұмыс уақыты және бізге қалай жетуге болады.' },
];
      ...
      <section className="hero">
        ...
        <div className="hero__content">
          ...
          <p className="hero__text">
            Кавказ атмосферасын қайта жаңғырту идеясы алғашқы қадамнан бастап қонақжайлылықпен қарсы алатын кафеге қалай айналғаны жайлы.
          </p>
        </div>
      </section>
        ...
        <Reveal>
          <div className="letter">
            ...
            <p className="letter__text">
              ...
              және қонақжайлылықпен тоғысқан ас үй арқылы ұсыну.
            </p>
